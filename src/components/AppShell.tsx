  ...
  return (
    <div className="relative min-h-screen gradient-hero">
      <header className="sticky top-0 z-40 glass-strong">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3">
          <Link to="/" className="flex items-center gap-2">
            ...
            <div className="font-display text-lg font-bold tracking-tight">TravAID</div>
          </Link>
      ...
      <footer className="mx-auto max-w-7xl px-4 py-8 text-center text-xs text-muted-foreground">
        TravAID • Stay safe out there. In a life-threatening emergency, call <strong>112</strong>.
      </footer>
    </div>
  );
}
